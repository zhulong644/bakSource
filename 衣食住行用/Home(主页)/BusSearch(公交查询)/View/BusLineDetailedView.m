...
@interface BusLineDetailedView ()
@property (nonatomic, strong) NSArray *busLines;
@end

@implementation BusLineDetailedView
...
- (void)setBusLine:(NSArray *)busLine
{
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BusLine *busLine = self.busLines[indexPath.row];
    detailText = busLine.name;
...
{
    BusLine *busLine = self.busLines[indexPath.row];
    BusAllLineDetailedView *busAll = [[BusAllLineDetailedView alloc] init];
    busAll.busLine = busLine;
    [self.navigationController pushViewController:busAll animated:YES];
}
